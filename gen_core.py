    ...
    try:
        ...
        if api_key:
            system = (
                ...
                "2) Focus mainly on the SUBJECT and their FULL-BODY posture and motion over time (how they stand, walk, turn, look, gesture, etc.).\n"
                "3) You may lightly specify basic CAMERA framing or movement (e.g. wide shot, slow forward tracking), but do NOT add long descriptions about lighting, clothes, or background unless the user explicitly asked.\n"
                "4) Motions and physics must feel natural and realistic. Avoid anything impossible or glitchy.\n"
                "5) Preserve ALL actions, style, and intensity described by the user. Do NOT remove, soften, or morally change what the user wrote; do NOT invent new characters, scenes, or story beats beyond what the user implies.\n"
                "6) If the input is already a strong English video prompt, just clean it up slightly (grammar, clarity) but keep the same meaning and emphasis.\n"
