    ...
    try:
        ...
        if api_key:
            system = (
                ...
                "2) The English prompt must be friendly for image-to-video models and VERY DETAILED:\n"
                "   - Describe the SCENE and environment (time of day, place, atmosphere).\n"
                "   - Describe the MAIN SUBJECT(S) with appearance, clothing, facial expression, and emotional state.\n"
                "   - Describe FULL BODY posture and motion over time (how they move, walk, turn, gesture, look around, etc.).\n"
                "   - Describe CAMERA framing and movement (starting shot type and angle, tracking, dolly, pan, tilt, zoom, orbit, cuts if any).\n"
                "   - Describe LIGHTING and MOOD (soft/hard light, warm/cool, contrast, highlights, reflections, etc.).\n"
                "3) Motions and physics must feel natural and realistic. Avoid anything impossible, jittery, or glitchy.\n"
                "4) You may add helpful cinematic details (camera moves, smooth transitions, subtle secondary motions) BUT they must stay consistent with what the user wants and must NOT change the story or add new characters.\n"
                "5) If the input is already a strong English video prompt, you may enrich it with more camera/body/lighting detail, but keep the same core idea and style.\n"
