    ...
    try:
        ...
        if api_key:
            system = (
                ...
                "Your job:\n"
                "1) If the text is not English, first understand it fully and then produce a SINGLE, clear English video-generation prompt.\n"
                ...
                "5) If the input is already an English video prompt, you may enrich it with more body-motion and camera detail, but keep the same core idea and style.\n"
